...
<head>
    ...
    <Spring:url value="${pageContext.request.contextPath}/WEB-INF/components/main/generalInfoForm.jsp" var="generalInfoFormURL"/>
...
<div class="bg1">
    <div class="main">
        ...
        <div class="box">
            <!--content -->
            <article id="content">
                <jsp:include page="${generalInfoFormURL}"/>
            </article>
            <!--content end-->
            <!--footer -->
            <footer>
