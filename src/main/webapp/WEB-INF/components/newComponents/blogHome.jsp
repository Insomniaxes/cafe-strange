    ...
    <div class="container">
        ...
        <div class="col-md-12">
            ...
            <p class="lead">Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis
                ...
                sit amet quam egestas semper. Aenean ultricies
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <div class="box-image-text blog">
                        <div class="top">
                            <div class="image">
                                <img src="${pageContext.request.contextPath}/img/portfolio-4.jpg" alt=""
                        ...
                        <div class="content">
                            ...
                            <p class="read-more"><a href="blog-post.html" class="btn btn-template-main">Continue
                                reading</a>
                            </p>
                        </div>
                    </div>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="box-image-text blog">
                        <div class="top">
                            <div class="image">
                                <img src="${pageContext.request.contextPath}/img/portfolio-5.jpg" alt=""
                                     class="img-responsive">
                            </div>
                            <div class="bg"></div>
                            <div class="text">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="box-image-text blog">
                        ...
                        <div class="content">
                            ...
                            <p class="intro">Am terminated it excellence invitation projection as. She graceful shy
                                believed distance use nay. Lively is people.</p>
                            <p class="read-more"><a href="blog-post.html" class="btn btn-template-main">Continue
                                reading</a>
                            </p>
                        </div>
